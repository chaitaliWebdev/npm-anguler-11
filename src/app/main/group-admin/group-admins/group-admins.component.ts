...
export class GroupAdminsComponent implements OnInit {
  ...
  getGroupAdmins(skip = 0): void {
    ...
    this.loading = true;
    this.httpRequestService.request('get', 'users/admins', params).subscribe(
      (result: any) => {
        this.loading = false;
        this.groupAdmins = result.data;
  ...
  onQueryParamsChange(params: NzTableQueryParams): void {
    ...
    this.getGroupAdmins(pageSize * (pageIndex - 1));
  }
